      ...
      <Stack width={'100%'} sx={{
        ...
        <Box sx={{
          ...
          <InfoPaper title={
            ...
            <PaperLine label="Payment method" value={order?.payment?.paymentMethod} icon={<AccountBalanceIcon sx={{ color: "#667085" }} />} />
            <PaperLine label="Payment status" value={order?.payment?.status} icon={<LocalAtmIcon sx={{ color: "#667085" }} />} />
          </InfoPaper>
          <InfoPaper title={
            <Stack direction='row' gap={2}>
              <Typography variant="h6">Customer</Typography>
            </Stack>} >
            <PaperLine label="Name" value={order?.profile?.fullName} icon={<AssignmentIndIcon sx={{ color: "#667085" }} />} />
            <PaperLine label="Phone" value={order?.profile?.phone} icon={<LocalPhoneIcon sx={{ color: "#667085" }} />} />
            <PaperLine label="Date of Birth" value={fromIsoToSimpleDate(order?.profile?.dateOfBirth)} icon={<CalendarMonthIcon sx={{ color: "#667085" }} />} />
          </InfoPaper>
        </Box>
        <Box sx={{
          width: '100%',
