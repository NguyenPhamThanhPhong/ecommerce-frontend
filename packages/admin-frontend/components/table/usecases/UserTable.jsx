...
const staticData = [
    createData(1, 'John Doe', doomAvatar, 'john.doe@example.com', '555-1234', '1990-01-15', 'Active', '2023-11-20', new Date()),
    createData(2, 'Jane Smith', anotherAvatar, 'jane.smith@example.com', '555-5678', '1985-07-04', 'Blocked', '2023-12-05',new Date('2023-12-05')),
    createData(3, 'David Lee', anotherAvatar, 'david.lee@example.com', '555-9012', '1978-10-28', 'Active', '2023-11-18',new Date('2023-11-18')),
...
function createData(id, name, avatar, email, phone, dateOfBirth, status, availableDate) {
    return {
        id,
        name,
        avatar,
